...
for td in td_elements:
    ...
    image = td.find('li', class_ = 'item-img hover-item-img')
    Product_link = td.find('a', class_='item-title')
...
# Find the div element with class 'modal fade modal-pc-builder-pdp show'
div = soup.find('div', class_='item-info')
